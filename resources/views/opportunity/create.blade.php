        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-3xl mx-auto mt-10">
                    <h1 class="text-2xl font-semibold mb-6">Create Opportunity</h1>
                    ...
                    <form action="{{ route('opportunities.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="organization" id="organization"
                                class="w-full border rounded p-2" value="{{ old('organization') }}">
                            @error('organization')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="5" class="w-full border rounded p-2">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="requirements" id="requirements" rows="4" class="w-full border rounded p-2">{{ old('requirements') }}</textarea>
                            @error('requirements')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="benefits" id="benefits" rows="4" class="w-full border rounded p-2">{{ old('benefits') }}</textarea>
                            @error('benefits')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="start_date" id="start_date"
                                    class="w-full border rounded p-2" value="{{ old('start_date') }}">
                                @error('start_date')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="end_date" id="end_date"
                                    class="w-full border rounded p-2" value="{{ old('end_date') }}">
                                @error('end_date')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="registration_link" id="registration_link"
                                class="w-full border rounded p-2" value="{{ old('registration_link') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="poster_url" id="poster_url"
                                class="w-full border rounded p-2" value="{{ old('poster_url') }}">
                            @error('poster_url')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
