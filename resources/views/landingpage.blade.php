...
<body class="bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 antialiased">
    ...
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <a href="{{ route('landing') }}" class="flex gap-4 items-center">
                ...
                <span class="text-2xl font-black text-blue-600 hidden md:block">
                    TAPAK
                </span>
            </a>
    ...
    <!-- ================= ABOUT ================= -->
    <section id="about" class="border-t border-gray-200 dark:border-gray-800 dark:bg-gray-950 px-6 py-24">
        <div class="max-w-7xl mx-auto max-w-4xl">
            ...
            <p class="mt-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                Di tengah banjir informasi dan janji kosong,
                TAPAK hadir sebagai ruang kurasi.
                Kami percaya peluang terbaik tidak perlu berteriak,
                cukup ditempatkan dengan jujur.
            </p>
        </div>
    </section>

    <!-- ================= OPPORTUNITIES ================= -->
    <section id="opportunities" class="bg-gray-50 dark:bg-gray-900 px-6 py-24">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @for ($i = 0; $i < 3; $i++)
                    <article
                        class="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 hover:shadow-xl transition">
                        ...
                        <div class="mt-8 flex justify-between items-center text-sm">
                            <span class="text-gray-500">Deadline · 12 Mar 2026</span>
    ...
    <!-- ================= FOOTER ================= -->
    <footer class="border-t border-gray-200 dark:border-gray-800 px-6 py-12">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-4 text-sm text-gray-500">
